        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="space-y-4 mb-8">
              {socials.map((s) => (
                ...
                >
                  <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center group-hover:neon-glow-cyan transition-all">
            ...
            <button className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-gradient-to-r from-primary to-accent text-primary-foreground font-semibold hover-lift neon-glow-cyan transition-all">
          ...
          >
            ...
            <textarea
              ...
              required
              className="w-full px-4 py-3 rounded-lg bg-background/50 border border-border/50 focus:border-primary/50 focus:ring-1 focus:ring-primary/30 outline-none transition-all text-sm resize-none"
            />
            <button
              type="submit"
              disabled={sending}
              className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-primary text-primary-foreground font-semibold hover-lift neon-glow-cyan transition-all disabled:opacity-50"
            >
