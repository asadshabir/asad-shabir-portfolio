...
const projects = [
  ...
  },
  {
    ...
    description: "Production-grade e-commerce with Stripe payments, Supabase auth, admin dashboard, and inventory management.",
  ...
  },
  {
    ...
    description: "Intelligent automation system that connects APIs, processes data, and triggers actions through custom rule-based pipelines.",
